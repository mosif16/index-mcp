...
| `repository_timeline` | Tool  | Generate a chronological digest of recent git commits, highlighting merges and file churn so agents stay aware of the latest changes. |
